...
import { Package, Users, Warehouse, FileText, Settings, ShoppingCart, MapPin, BarChart3, TrendingUp, Layers, FileSpreadsheet, Truck } from "lucide-react";
...
export default async function AdminLayout({
  ...
  const navigation = [
    ...
    { name: "Logistyka", href: "/admin/logistyka", icon: Truck },
